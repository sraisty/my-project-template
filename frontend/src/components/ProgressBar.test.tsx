...
describe('ProgressBar', () => {
  it('renders the progress bar with the correct width', () => {
    render(<ProgressBar percentDone={0.5} onClickReset={vi.fn()} onClickUpdate={vi.fn()} />)
  ...
  it('calls onClickReset when the Reset button is clicked', () => {
    ...
    render(<ProgressBar percentDone={0.5} onClickReset={mockReset} onClickUpdate={vi.fn()} />)
  ...
  it('calls onClickUpdate when the Increase Percent Done button is clicked', () => {
    ...
    render(<ProgressBar percentDone={0.5} onClickReset={vi.fn()} onClickUpdate={mockUpdate} />)
